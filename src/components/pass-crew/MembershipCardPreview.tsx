...
export default function MembershipCardPreview({
  ...
  return (
    ...
    >
      <div className="relative aspect-[1.586/1] w-full max-w-[560px] min-w-0 overflow-hidden border border-[#d7bc78]/80 bg-[linear-gradient(135deg,#f1d995_0%,#b9954d_48%,#e6ca86_100%)] p-6 text-[#1b1710] shadow-[0_24px_70px_-25px_rgba(214,177,92,.6)] sm:p-8">
