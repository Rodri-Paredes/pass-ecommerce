...
import { CITIES, type Branch } from '../../types';
...
export default function Cart() {
  ...
  const total = items.reduce((sum, item) => { const discount = activeDiscountsMap.get(item.product.id); const price = discount ? item.product.price * (1 - discount.percentage / 100) : item.product.price; return sum + price * item.quantity; }, 0);
